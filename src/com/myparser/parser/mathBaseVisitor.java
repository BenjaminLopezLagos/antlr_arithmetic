...
public class mathBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements mathVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitProd(mathParser.ProdContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitExp(mathParser.ExpContext ctx) { return visitChildren(ctx); }
}